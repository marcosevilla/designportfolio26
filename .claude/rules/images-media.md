...
- **Cross-device screenshot comparison: match the dp viewport, not the pixel count.** `deviceScaleFactor` matters more than pixel dimensions — a 1080px-wide shot from a 2.625× Pixel (412dp) has different content scale than a 3× Samsung (360dp) at the same pixel width.
