...
- **Latest (2026-07-20, main, ninth pass — ALL DEPLOYED, verified live on www.marcosevilla.com):** Everything through b9495d6 pushed via the editor's new /publish endpoint (its first live run: committed:false, pushed:true — the edit→save→publish loop is now proven end-to-end). Two passes on top of the editor + dither work:
