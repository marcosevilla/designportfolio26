  ...
  return (
    <>
      ...
      <article className="text-[var(--color-fg-secondary)]" style={typescale.body}>
        {/* Hero */}
        <CaseStudyHero
          title="Building Productivity Software for Engineers"
          subtitle="Designing a web-based task management tool that gives software engineers a holistic view of their workload by integrating popular project management tools in one surface."
          gradient={["#334155", "#1E293B"]}
          heroImageDescription="Hero shot — General Task home page interface"
        />
        ...
        <div className="mt-8">
          <div>
            ...
            <ExpandableSection title="User Research" id="research">
              ...
              <h3
                className="font-medium text-[var(--color-fg)] mb-6 mt-10 tracking-tight"
                style={typescale.h3}
              >
                Research Highlights
              </h3>
