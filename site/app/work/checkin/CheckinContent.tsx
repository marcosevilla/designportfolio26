  ...
  return (
    <>
      ...
      <article className="text-[var(--color-fg-secondary)]" style={typescale.body}>
        {/* Hero */}
        <CaseStudyHero
          title="Modernizing Hotel Software"
          subtitle="Designing digital check-in, compendium, and omni-channel communication solutions for the world's largest hotel chains."
