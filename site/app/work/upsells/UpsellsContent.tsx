      ...
      <article className="text-[var(--color-fg-secondary)]" style={typescale.body}>
        ...
        <TwoCol>
          <TwoCol.Left>
            ...
            <p className="mt-3 text-[var(--color-fg-secondary)]" style={typescale.subtitle}>A configurable form system that lets hotels collect custom guest information at the point of upsell purchase — turning simple add-ons into structured service requests.</p>
          </TwoCol.Left>
        </TwoCol>
        ...
        <FadeIn as="section" className="scroll-mt-24 pt-32">
          ...
          <div className="space-y-14 mt-6">
            <FadeIn>
              <TwoCol>
                <TwoCol.Left>
                  <SectionHeading level={4}>1. Full-page creation flow with live preview</SectionHeading>
                  <p className="mb-5">
            ...
            <FadeIn>
              <TwoCol>
                <TwoCol.Left>
                  <SectionHeading level={4}>2. Form fields as &ldquo;Guest Information&rdquo; within the upsell</SectionHeading>
                  <p className="mb-5">
            ...
            <FadeIn>
              <TwoCol>
                <TwoCol.Left>
                  <SectionHeading level={4}>3. Guest form appears before submission, not after</SectionHeading>
                  <p className="mb-5">
            ...
            <FadeIn>
              <TwoCol>
                <TwoCol.Left>
                  <SectionHeading level={4}>4. Constraint-based UX with clear feedback</SectionHeading>
                  <p className="mb-5">
            ...
            <FadeIn>
              <TwoCol>
                <TwoCol.Left>
                  <SectionHeading level={4}>5. Staff responses surfaced in context</SectionHeading>
                  <p className="mb-5">
            ...
            <TwoCol className="mt-10">
              <TwoCol.Left>
                <div className="space-y-8">
                  <div>
                    <SectionHeading level={4}>Research & prototyping (Apr–May 2025)</SectionHeading>
                    <p>
                  ...
                  <div>
                    <SectionHeading level={4}>Full-page creation + live preview (May–Jun 2025)</SectionHeading>
                    <p>
                  ...
                  <div>
                    <SectionHeading level={4}>MVP scope-down & launch (Jun–Jul 2025)</SectionHeading>
                    <p>
                  ...
                  <div>
                    <SectionHeading level={4}>Guest frontend + dashboard (Jul–Sep 2025)</SectionHeading>
                    <p>
