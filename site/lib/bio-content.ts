...
export const PARAGRAPHS: Paragraph[] = [
  [
    { text: "With eight years of experience across consumer and enterprise products, I currently work at the intersection of systems thinking and visual craft. At" },
...
// All 36 bio variants (6x6 grid: casual-professional x concise-verbose)
export const BIO_VARIANTS: BioVariant[] = [
  ...
  { x: 3, y: 0, heading: "Hi, I'm Marco. I design software in San Francisco.", paragraphs: [[{ text: "Product Designer at Canary Technologies. Eight years of experience building consumer and enterprise products." }]] },
  { x: 4, y: 0, heading: "Marco Sevilla — Product Designer", paragraphs: [[{ text: "Eight years of experience across consumer and enterprise software. Currently leading design initiatives at Canary Technologies." }]] },
  { x: 5, y: 0, heading: "Marco Sevilla, Senior Product Designer", paragraphs: [[{ text: "Specializing in design systems and visual craft. Eight years of experience building scalable platforms for global hospitality brands." }]] },
  ...
  { x: 3, y: 1, heading: "Hi, I'm Marco. I design software in San Francisco.", paragraphs: [
    [{ text: "Product Designer at" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", building platforms for the hospitality industry. Eight years of experience creating both 0→1 products and scalable design systems." }],
  ] },
  { x: 4, y: 1, heading: "Marco Sevilla — Product Designer", paragraphs: [
    [{ text: "With eight years of experience, I design enterprise platforms at" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: "that serve millions of hotel guests globally across Marriott, Wyndham, Best Western, and IHG properties." }],
  ] },
  ...
  { x: 2, y: 2, heading: "MARCO SEVILLA", paragraphs: [
    [{ text: "Product designer in San Francisco with eight years of experience. Currently at" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", designing platforms for global hospitality brands." }],
  ...
  { x: 3, y: 2, heading: "Hi, I'm Marco. I design software in San Francisco.", paragraphs: [
    [{ text: "With eight years of experience across consumer and enterprise products, I currently work at the intersection of systems thinking and visual craft. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I design platforms serving millions globally." }],
  ...
  { x: 4, y: 2, heading: "Marco Sevilla — Product Designer", paragraphs: [
    [{ text: "Eight years of experience building consumer and enterprise software. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I lead design for hospitality platforms serving Marriott, Wyndham, Best Western, and IHG." }],
  ...
  { x: 2, y: 3, heading: "MARCO SEVILLA", paragraphs: [
    [{ text: "Product designer with eight years of experience across consumer and enterprise products. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I design platforms serving millions of hotel guests globally." }],
  ...
  { x: 5, y: 3, heading: "Marco Sevilla, Senior Product Designer — San Francisco", paragraphs: [
    [{ text: "Eight years of experience delivering consumer and enterprise software solutions. Currently at" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", where I architect design systems and lead product design initiatives for hospitality platforms serving millions of guests across Marriott, Wyndham, Best Western, and IHG properties worldwide." }],
  ...
  { x: 2, y: 4, heading: "MARCO SEVILLA", paragraphs: [
    [{ text: "Product designer with eight years of experience. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I work on hospitality platforms serving major hotel brands worldwide." }],
  ...
  { x: 4, y: 4, heading: "Marco Sevilla — Product Designer in San Francisco", paragraphs: [
    [{ text: "Eight years of professional experience delivering consumer and enterprise software. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I lead design for hospitality platforms serving millions across Marriott, Wyndham, Best Western, and IHG properties worldwide." }],
  ...
  { x: 5, y: 4, heading: "Marco Sevilla, Senior Product Designer — San Francisco", paragraphs: [
    [{ text: "Eight years of experience across consumer and enterprise software development. Currently at" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", leading design initiatives for hospitality platforms deployed across major hotel brands including Marriott, Wyndham, Best Western, and IHG, serving millions of guests globally." }],
  ...
  { x: 2, y: 5, heading: "MARCO SEVILLA", paragraphs: [
    [{ text: "Product designer with eight years of experience. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I design hospitality platforms serving major hotel brands including Marriott, Wyndham, Best Western, and IHG." }],
  ...
  { x: 4, y: 5, heading: "Marco Sevilla — Product Designer in San Francisco", paragraphs: [
    [{ text: "Eight years of professional experience building consumer and enterprise software. At" }, { text: "Canary Technologies", href: "https://www.canarytechnologies.com/" }, { text: ", I lead design for hospitality platforms serving millions of guests across Marriott, Wyndham, Best Western, and IHG properties worldwide." }],
